...
rpLibPutString(io,'output.log',...
               sprintf('%s\n', 'Literature/Interpolated (i) Values ====================================================='),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-----+------------+------------+------------+------------+------------+---------------+'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '| Mat |   lc [A]   |  C11i[GPa] |  C12i[GPa] |  Poisson v |  a_perp[A] | Misfit Strain |'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-----+------------+------------+------------+------------+------------+---------------+'),1);
...
rpLibPutString(io,'output.log',...
               sprintf('\n%s\n', 'Empirically Calculated (e) Values ========================'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-----+------------+------------+------------+------------+'),1);
rpLibPutString(io,'output.log',...
...
rpLibPutString(io,'output.log',...
               sprintf('\n%s\n', 'Superlattice Critical Thickness =================================='),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-------------+------------+------------+------------+------------+'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '|   Params    | Eff lc [A] | Eff Misfit |  Crit SL   |   Max SL   |'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '|    Used     |            |   Strain   | Thick [nm] |   Units    |'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-------------+------------+------------+------------+------------+'),1);
fmt = '| %11s | %0.4e | %0.4e | %0.4e | %0.4e |\n';
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '| CET (QD Height as QW)                                           |'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-------------+------------+------------+------------+------------+'),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Lit (i)', a0SLQDCETi, e0SLQDCETi, hcCETi, maxCETi),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Calc (e)', a0SLQDCETa, e0SLQDCETa, hcCETa, maxCETa),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-------------+------------+------------+------------+------------+'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '| Modified CET (QD as Cylinder)                                   |'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-------------+------------+------------+------------+------------+'),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Lit (i) QD', a0SLQDmCETcyli, e0SLQDmCETcyli, hcmCETQDcyli, maxmCETQDcyli),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Calc (e) QD', a0SLQDmCETcyla, e0SLQDmCETcyla, hcmCETQDcyla, maxmCETQDcyla),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Lit (i) WL', a0SLWLmCETcyli, e0SLWLmCETcyli, hcmCETWLcyli, maxmCETWLcyli),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Calc (e) WL', a0SLWLmCETcyla, e0SLWLmCETcyla, hcmCETWLcyla, maxmCETWLcyla),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-------------+------------+------------+------------+------------+'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '| Modified CET (QD as Oblate-Hemispheroid)                        |'),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-------------+------------+------------+------------+------------+'),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Lit (i) QD', a0SLQDmCETsphi, e0SLQDmCETsphi, hcmCETQDsphi, maxmCETQDsphi),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Calc (e) QD', a0SLQDmCETspha, e0SLQDmCETspha, hcmCETQDspha, maxmCETQDspha),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Lit (i) WL', a0SLWLmCETsphi, e0SLWLmCETsphi, hcmCETWLsphi, maxmCETWLsphi),1);
rpLibPutString(io,'output.log',...
               sprintf(fmt, 'Calc (e) WL', a0SLWLmCETspha, e0SLWLmCETspha, hcmCETWLspha, maxmCETWLspha),1);
rpLibPutString(io,'output.log',...
               sprintf('%s\n', '+-------------+------------+------------+------------+------------+'),1);
